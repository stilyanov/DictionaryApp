...
public class InitLanguages implements CommandLineRunner {
    ...
    private final Map<LanguageEnum, String> languagesDescription = Map.of(
    ...
    public void run(String... args) throws Exception {
        ...
        for (LanguageEnum languageEnum : languagesDescription.keySet()) {
            Language language = new Language(languageEnum, languagesDescription.get(languageEnum));
